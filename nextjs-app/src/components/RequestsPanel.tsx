...
export default function RequestsPanel({ requests, onRefresh }: Props) {
  // Bug fix: each row needs its OWN note string; a single shared state caused
  // the note typed for row A to be submitted for row B if the admin clicked
  // approve/reject on a different row without clearing.
